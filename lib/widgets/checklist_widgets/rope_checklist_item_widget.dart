...
class RopeChecklistItemWidget extends StatefulWidget {
  final bool comments;
  final checklistItem;
  RopeChecklistItemWidget({ @required required this.checklistItem, @required required this.comments });
  @override
  _RopeChecklistItemWidgetState createState() => _RopeChecklistItemWidgetState();
}

class _RopeChecklistItemWidgetState extends State<RopeChecklistItemWidget> {
