...
class _LongLinesDetailsState extends State<LongLinesDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    longLineInfo = longLinesProvider.longLinesProvider.singleWhere((element) => element.id == widget.id);

    DateFormat formatter = DateFormat('MMMM dd, yyyy');
    var inspectionDate = formatter.format(this.longLineInfo.inspectionDate.toDate());
    var nextInspection = formatter.format(this.longLineInfo.nextInspectionDate.toDate());
                ...
                child: ExpansionTile(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ListTile(
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(builder: (context) => InpsectionChecklists()));
                        },
                        tileColor: Colors.white,
                        leading: Container(
                          width: 25,
                ...
                switch(val){
                  case 0: {
                    Navigator.of(context).push(MaterialPageRoute(builder: (context) => 
                      LongLinesForm(longline: this.longLineInfo, formType: 'edit')));
                    break;
                  }
                  case 1: {
                    print('Load Map');
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  height: 125,
                  child: ClipOval(
                    child: longLineInfo.imagePath.isEmpty ? Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text(
                          longLineInfo.type,
