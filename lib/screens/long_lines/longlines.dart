                ...
                Expanded(
                  child: ListView.separated(
                    ...
                    itemBuilder: (_, int index) {
                      final LongLinesModel longline = longLinesProvider.longLinesProvider[index];
      ...
      child: InkWell(
        onTap: () {
           Navigator.push(
            context,
            PageRouteBuilder(
                pageBuilder: (context, _, __) => LongLinesDetails(id: this.longline.id)));
        },
        child: ListTile(
          leading: Container(
            width: 55,
            ...
            child: ClipOval(
              child: longline.imagePath.isEmpty ? Column(
          ...
          subtitle: Text('${longline.length} ${longline.type} ${longline.safeWorkingLoad}#'),
